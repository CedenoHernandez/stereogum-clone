...
class Featured extends Component {
  ...
  render() {
    ...
    //   let i;
    //   let slides = document.getElementsByClassName('featured-titles');
    //   if (n > slides.length) {
    //     slideIndex = 1
    //   }
    //   if (n < 1) {
    ...
    return(
      <div className="featured">
        ...
        <button type="button" className="scroll" /*onClick={() => plusSlides(-1)}*/ >
           <i>◄</i>
        </button>
        
        {/* Display 1 */}
        
        <div className="featured-titles tile-1" id="display1">
        ...
        <div className="featured-titles tile-2" id="display1">
        ...
        <div className="featured-titles tile-3" id="display1">
        ...
        <div className="featured-titles tile-4" id="display1">
        ...
        <div className="featured-titles tile-5" id="display2">
        ...
        <div className="featured-titles tile-6" id="display2">
